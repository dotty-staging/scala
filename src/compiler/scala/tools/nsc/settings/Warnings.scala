...
trait Warnings {
  ...
  object LintWarnings extends MultiChoiceEnumeration {
    ...
    val StructuralType         = LintWarning("structural-type",           "Warn on definitions with an inferred structural type.")
  ...
  def warnStructuralType         = lint contains StructuralType
